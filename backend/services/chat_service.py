...
def _general_answer(question: str, answer_type: str) -> dict[str, Any]:
    q = (question or "").strip()
    ...
    return {"answer": answer, "answer_type": answer_type, "confidence": 0.7, "confidence_label": _confidence_note(0.7), "used_contract": False, "evidence": [], "plain_english_summary": summary, "practical_note": "If your question is about the selected contract, ask it with the relevant topic or clause name.", "follow_up_suggestions": ["Summarize this contract", "What risks should I review first?", "Explain the key obligations", "What should I negotiate?"], "degraded_mode": False, "llm_used": False}


def _fallback_contract_answer(question: str, evidence: list[dict[str, Any]], answer_type: str, llm_unavailable: bool = False) -> dict[str, Any]:
    ...
    if llm_unavailable:
        answer = "AI model unavailable — rule-based contract answer shown. " + answer
...
def _chat_prompt(question: str, contract_text: str, evidence: list[dict[str, Any]], answer_type: str) -> str:
    return f"""
